...
export class WeatherManager {
  ...
  setWeather(weather, isAuto = false) {
    const oldWeather = this.data.current;
    this.data.current = weather;
    this.data.mode = isAuto ? "auto" : "manual";
    ...
    if (oldWeather !== weather) {
      ...
      CalendarState.update("weather.current", weather);
      CalendarState.update("weather.mode", this.data.mode);
    }
  ...
  generateWeather(season = null) {
    if (this.data.mode !== "auto") return null;
